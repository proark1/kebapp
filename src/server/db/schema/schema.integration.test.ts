...
const expectedForeignKeys = [
  ...
  "demand_items.organization_id->demand_submissions.organization_id",
  "demand_submissions.buying_round_id->buying_rounds.id",
  "demand_submissions.confirmed_by_user_id->user.id",
  ...
  "demand_template_items.template_id->demand_templates.id",
  "demand_template_items.organization_id->demand_templates.organization_id",
  ...
  "goods_receipt_items.organization_id->goods_receipts.organization_id",
  "goods_receipts.buying_round_id->buying_rounds.id",
  "goods_receipts.organization_id->organizations.id",
  "goods_receipts.saved_by_user_id->user.id",
  "guest_order_items.order_id->guest_orders.id",
  "guest_order_items.organization_id->guest_orders.organization_id",
  "guest_order_items.organization_id->organizations.id",
  "guest_orders.guest_id->guests.id",
  "guest_orders.organization_id->guests.organization_id",
  "guest_orders.organization_id->organizations.id",
  "guests.organization_id->organizations.id",
  "hygiene_entries.completed_by_user_id->user.id",
  "hygiene_entries.organization_id->organizations.id",
  "hygiene_items.entry_id->hygiene_entries.id",
  "hygiene_items.organization_id->hygiene_entries.organization_id",
  "hygiene_items.organization_id->organizations.id",
  ...
  "invitations.revoked_by_user_id->user.id",
  "loyalty_redemptions.guest_id->guests.id",
  "loyalty_redemptions.organization_id->guests.organization_id",
  "loyalty_redemptions.organization_id->organizations.id",
  "loyalty_redemptions.redeemed_by_user_id->user.id",
  ...
  "platform_imports.imported_by_user_id->user.id",
  "platform_imports.organization_id->organizations.id",
  "platform_roles.granted_by_user_id->user.id",
  "platform_roles.user_id->user.id",
  "registration_requests.organization_id->organizations.id",
  "registration_requests.reviewed_by_user_id->user.id",
  "registration_requests.user_id->user.id",
  ...
  "sales_daily.organization_id->organizations.id",
  "session.user_id->user.id",
  "store_profiles.organization_id->organizations.id",
  "support_assignments.assigned_by_user_id->user.id",
  "support_assignments.organization_id->organizations.id",
  "support_assignments.support_user_id->user.id",
  "time_entries.corrected_by_user_id->user.id",
  "time_entries.organization_id->organizations.id",
  "time_entries.user_id->user.id",
...
const expectedUniqueIndexes = [
  ...
  "hygiene_entries_org_date_unique",
  "incoming_invoices_org_number_unique",
